...
TEST_F( ISOTPOverCANProtocolTest, isotpSenderTestLifeCycle_LinuxCANDep )
{
...
TEST_F( ISOTPOverCANProtocolTest, isotpSenderTestSendSingleFramePDU_LinuxCANDep )
{
    ISOTPOverCANSender sender;
    ISOTPOverCANSenderOptions options;
    options.mSocketCanIFName = "vcan0";
...
TEST_F( ISOTPOverCANProtocolTest, isotpReceiverTestLifeCycle_LinuxCANDep )
{
...
TEST_F( ISOTPOverCANProtocolTest, isotpSendAndReceiveSingleFrame_LinuxCANDep )
{
    // Setup the sender
    ISOTPOverCANSender sender;
...
TEST_F( ISOTPOverCANProtocolTest, isotpSendAndReceiveMultiFrame_LinuxCANDep )
{
    // Setup the sender
    ISOTPOverCANSender sender;
    ISOTPOverCANSenderOptions senderOptions;
...
TEST_F( ISOTPOverCANProtocolTest, isotpSendAndReceiveSameSocket_LinuxCANDep )
{
